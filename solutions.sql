...
--7. Find all the movies/TV shows by directors 'Rajiv Chilaka'!
...
--13. Find how many movies actor 'Salman Khan' appeared in list 10 years!
...
-- Label the content containing these keywords as 'Bad' and all other content as 'Good'. Count how many items fall into each category.
